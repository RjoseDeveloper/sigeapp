...
//require '../view/fragments';
             ...
             /*-------------------------------------------*/
              ...
              $pdf->setXY(130,35);
              $pdf->Cell(50,5,$publicar_pauta->get_nome_dir_adj($idcurso,0),0,0,'C');
	    ...
	    $pdf->SetTextColor(255,  255, 255);
              ...
              $pdf->MultiCell(40,6,$column_nota,1,'C');
                ...
                $pdf->MultiCell(0,6,utf8_decode("Observações Gerais"),0,'C');

              $pdf->SetFont('Arial','I',8);
              // Page number
              $pdf->SetXY(30,255);
              $pdf->Cell(30,5,'Docente/s da Disciplina',0,0,'L');

              $pdf->SetXY(20,260);
              $pdf->Cell(60,5,"_____________________/_________________",0,0,'L');
             ...
             // if ($row['sexo'] == 'M'){
                ...
                $doc.=utf8_encode($row['nomeCompleto'].', '. $row['idgrau'].''.$sexo);
...
// Page number
$pdf->SetXY(100,255);
$pdf->Cell(30,5,'Director do Curso',0,0,'');

$pdf->SetXY(90,260);
$pdf->Cell(50,5,"___________________________",0,0,'');

$pdf->SetXY(98,265);
$pdf->Cell(30,10,$publicar_pauta->get_Director_Curso($idcurso),0,0,'');
