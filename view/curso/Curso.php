            ...
            <div id="g_cursos"  >
                ...
                <div class="new_curso">
                    ...
                    <div class="col-sm-12" style="">
                        <div style="border: none" class="mensagem_d alert-success">Criar nova classe</div>
                        <input type="text" name="" class="form-control" id="txt_desc"
                         placeholder="Descrição da Classe"/>
                        <input type="text" name="" class="form-control" value="" id="txt_cod" placeholder="Codigo do Curso"/>
                        <input type="search" name="" class="form-control" value="" id="txt_dir" placeholder="Director da Classe"/>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="ctr_error" style="color:red; text-align: center">Caro houve problemas na insercao dos dados </div>
            </div>
        </div>
    </div>
</div>
