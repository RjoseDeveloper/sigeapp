		...
		<div class="panel-heading">
		    <div class="btn-group pull-right">
				<button type='button' class="btn btn-primary" data-toggle="modal" data-backdrop="false"
                        data-target="#nuevoProducto"><span class="glyphicon glyphicon-plus" ></span> Nova Classe</button>
			</div>
			<h4><i class='glyphicon glyphicon-search'></i> Buscar Classes</h4>
		</div>
		...
		<div class="panel-body">
			...
			<form class="form-horizontal" role="form" id="datos_cotizacion">
						...
						<div class="form-group row">
							<label for="q" class="col-md-2 control-label">Código da Classe</label>
							<div class="col-md-5">
