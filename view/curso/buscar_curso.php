			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_assoc($query)){
						...
						$nombre_completo= utf8_encode($row['fullname']);
                    ...
                    <tr>
						...
						<td style="text-align: left"><?php echo utf8_encode($nombre_completo);?></td>
					...
					<a href="#" class='btn btn-default' data-backdrop="false" title='Editar Curso' onclick="obtener_datos('<?php echo $idcurso;?>');" data-toggle="modal" data-target="#myModal2"><i class="glyphicon glyphicon-edit"></i></a>
                            <a href="#" class='btn btn-default' title='Eliminar Curso' onclick="eliminar('<?php echo $idcurso; ?>')"><i class="glyphicon glyphicon-trash"></i> </a></span>
                           <br> <br> <?php echo '<a href="../turma/turmas.php"  target="frm_content" style="color: #ff33cc;" >Criar Turma</a>';?>
                        </td>
