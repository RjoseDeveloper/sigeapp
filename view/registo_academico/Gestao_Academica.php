        ...
        <div class="col-md-3">
            <ul class="list-group">
                ...
                <li class="list-group-item" value="">
                    <a href="../aluno/aluno.php" target="frm_content" style=""> <?php echo 'Total Alunos';?>
                        <span class="pull-right badge"> <?php echo $func->getCountRow('utilizador','id') ; ?></span>
                    </a></li>

                

                <li class="list-group-item" value="">
                    <a href="../utilizador/usuarios.php" target="frm_content" style=""> <?php echo 'Total Utilizadores';?>
                        <span class="pull-right badge"> <?php echo $func->getCountRow('utilizador','id') ?></span>
                    </a></li>

                <li class="list-group-item" value="">
                    <a href="../curso/cursos.php" target="frm_content" style=""> <?php echo 'Total Classes';?>
                        <span class="pull-right badge"> 
                            <?php echo $func->getCountRow('curso','idcurso') ?></span>
                    </a></li>
            ...
            <div class="panel panel-warning">
                ...
                <div class="panel-heading"><?php echo 'Total: Pagamentos Pendentes -'. date("Y");?></div>
                <div class="panel-body"><h3 class="pull-right"><?php echo '0,00'; ?></h3></div>
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading"><?php echo 'Total: Pagamentos Gerais -'. date("Y");?></div>
...
<!--            </div>-->
            ...
            <div class="table-responsive col-md-12">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body" style="height: 350px"><h3>
                        <?php echo 'RELACAO GRAFICA'; ?>
                        </h3>
            ...
            <div class="table-responsive col-md-12">
                <div class=" alert alert-warning">TOTAL DE ALUNOS POR CLASSE</div>
