    ...
    <div data-role="content" style="padding:5px 10px">
        <div class="col-md-3">
            ...
            <div class="panel panel-warning">
                ...
                <div class="panel-heading"><?php echo 'Total de Homens -'. date("Y");?></div>
                <div class="panel-body"><h3 class="pull-right"><?php echo $func->getSumRow('despesa','valor').''; ?></h3></div>
                <div class="panel-footer">Total Geral ... <span>1200</span></div>

            </div>

            <div class="panel panel-info">

                <div class="panel-heading"><?php echo 'Total de Mulheres -'. date("Y");?></div>
                <div class="panel-body"><h3 class="pull-right"><?php echo $func->getSumRow('orcamento','valor').''; ?></h3></div>
                <div class="panel-footer">Total Geral ...<span>1000</span></div>
...
<!--            </div>-->
            ...
            <div class="table-responsive col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">CAIXA DE MENSAGENS E NOTIFICAÇÕES</div>
                    <div class="panel-body" style="height: 350px">

                        <div class="box">

                            <h3 style="color:red"><?php echo 'Caixa de Mensagem Vazia, Aguarde !!'; ?>
                            </h3>
                        </div>
